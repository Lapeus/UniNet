...
public class BeitragServlet extends HttpServlet {
	...
	private void likeBeitrag(HttpServletRequest request, HttpServletResponse response) throws IOException {
		HttpSession session = request.getSession();
		int userID = Integer.parseInt(session.getAttribute("UserID").toString());
	...
	private void kommentieren(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		HttpSession session = request.getSession();
		int userID = Integer.parseInt(session.getAttribute("UserID").toString());
		int beitragsID = Integer.parseInt(request.getParameter("beitragsID"));
		String page = request.getParameter("page");
	...
	private void kommentarAntworten(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		HttpSession session = request.getSession();
		int userID = Integer.parseInt(session.getAttribute("UserID").toString());
	...
	private void melden(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		HttpSession session = request.getSession();
		int userID = Integer.parseInt(session.getAttribute("UserID").toString());
		int beitragsID = Integer.parseInt(request.getParameter("beitragsID"));
		String page = request.getParameter("page");
	...
	public List<Beitrag> getBeitraege(HttpServletRequest request, Connection con, String seite, int userID, String... optionalParams) throws SQLException {
		HttpSession session = request.getSession();
		// Beitraege
		String sql = "";
		PreparedStatement pStmt = con.prepareStatement(sql);
